    ...
    <div className="min-h-screen bg-[#f6f6f6] relative flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md bg-white border border-[rgba(30,30,30,0.1)] rounded p-8 shadow-sm">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          {/* Divider - DISABLED: Registration temporarily disabled */}
          ...
          {/* Google Sign In - DISABLED: Registration temporarily disabled */}
          {/* <button
            type="button"
          ...
          {/* Apple Sign In - DISABLED: Registration temporarily disabled */}
          {/* <button
            type="button"
        ...
        {/* Switch mode - DISABLED: Registration temporarily disabled */}
