        ...
        return (
          <div className="space-y-4">
            <input
              ...
              className="w-full h-2 bg-[rgba(30,30,30,0.08)] rounded-lg appearance-none cursor-pointer accent-[#40086d]"
            />
            <div className="flex justify-between text-sm text-gray-500">
              <span>{step.min}</span>
              <span className="text-3xl font-bold text-[#40086d]">{sliderValue}</span>
              <span>{step.max}</span>
            </div>
          </div>
        );
