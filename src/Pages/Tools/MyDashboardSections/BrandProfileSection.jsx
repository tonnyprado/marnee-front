  ...
  return (
    <div>
      ...
      <div className="h-2 rounded-full bg-gray-100 overflow-hidden">
        <div
          className="h-full rounded-full bg-[#40086d]"
          style={{ width: `${value}%` }}
        />
      </div>
    </div>
  ...
  return (
    <div className="border border-[rgba(30,30,30,0.1)] rounded p-4 bg-white shadow-sm">
      <div className="flex items-center justify-between mb-2">
        <div className="h-8 w-8 rounded bg-[#ede0f8] flex items-center justify-center text-xs font-semibold text-[#40086d]">
          CP
        </div>
    ...
    <>
      ...
      <div className="bg-white border border-[rgba(30,30,30,0.1)] rounded p-5 shadow-sm">
        ...
        <div className="mt-4 grid grid-cols-[20px_1fr] gap-4">
          <div className="flex flex-col items-center">
            <div className="h-3 w-3 rounded-full bg-[#40086d]" />
            <div className="flex-1 w-px bg-[#dccaf4]" />
            <div className="h-3 w-3 rounded-full bg-[#40086d]" />
            <div className="flex-1 w-px bg-[#dccaf4]" />
            <div className="h-3 w-3 rounded-full bg-[#40086d]" />
          </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-[rgba(30,30,30,0.1)] rounded p-5 shadow-sm">
          ...
          <div className="mt-4 border-2 border-dashed border-gray-200 rounded bg-[#f6f6f6] py-10 text-center">
            ...
            {["A", "B", "C"].map((key, index) => (
              <div
                ...
                className={`h-14 w-14 rounded flex items-center justify-center border ${
                  index === 2
                    ? "bg-[#40086d] text-white border-transparent"
