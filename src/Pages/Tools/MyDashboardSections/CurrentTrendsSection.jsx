  ...
  return (
    <div className="bg-white border border-[rgba(30,30,30,0.1)] rounded p-4 shadow-sm">
      <div className="flex items-center gap-2">
        <span className="h-7 w-7 rounded-full bg-[#ede0f8] text-[#40086d] text-xs font-semibold flex items-center justify-center">
          #{rank}
        </span>
...
function ViralCard({ title, mentions, engagement, relevance, sources, score }) {
  return (
    <div className="bg-white border border-[rgba(30,30,30,0.1)] rounded p-4 shadow-sm">
      ...
      <div className="mt-2">
        <span className="text-xs px-2 py-0.5 rounded-full bg-[#ede0f8] text-[#40086d]">
...
function TrendCard({ title, category, score, description, stats, tags, actions }) {
  return (
    <div className="bg-white border border-[rgba(30,30,30,0.1)] rounded p-5 shadow-sm">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs text-[#40086d] font-semibold">{category}</p>
          <h3 className="text-base font-semibold text-gray-900">{title}</h3>
        </div>
        <div className="h-7 w-7 rounded-full bg-[#ede0f8] text-[#40086d] text-xs font-semibold flex items-center justify-center">
          {score}
        </div>
      </div>
      ...
      <div className="mt-3 grid grid-cols-4 gap-2">
        {stats.map((s) => (
          <div key={s.label} className="bg-[#f6f6f6] rounded p-2 text-center">
      ...
      <div className="mt-3 flex gap-2">
        {actions.map((a) => (
          <button
            key={a}
            className="px-3 py-1.5 rounded text-xs font-semibold border border-[#dccaf4] text-[#40086d] hover:bg-[#ede0f8]"
          >
            {a}
          </button>
        ))}
    ...
    <>
      ...
      <div className="bg-white border border-[rgba(30,30,30,0.1)] rounded p-4 shadow-sm">
        <div className="flex items-center gap-3">
          <span className="text-xs px-3 py-1 rounded-full bg-[#ede0f8] text-[#40086d] font-semibold">
            YOUR BRAND NICHE
          </span>
          <div>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-500">
          ...
          <button className="px-3 py-1.5 rounded bg-[#ede0f8] text-[#40086d] font-semibold">
            This Week
          </button>
