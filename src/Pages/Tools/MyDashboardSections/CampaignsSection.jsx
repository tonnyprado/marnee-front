...
export default function CampaignsSection() {
  ...
  const statusStyles = {
    ...
    Scheduled: "bg-[#ede0f8] text-[#40086d]",
  ...
  return (
    <>
      ...
      <div className="bg-white border border-[rgba(30,30,30,0.1)] rounded overflow-hidden shadow-sm">
        ...
        <div className="divide-y divide-[rgba(30,30,30,0.08)]">
          {campaigns
            .filter((c) => {
              ...
              <div key={c.id}>
                <div
                  className={`grid grid-cols-9 gap-4 px-6 py-4 items-center cursor-pointer transition ${
                    selectedCampaign === c.id ? "bg-[#ede0f8]" : "hover:bg-gray-50"
                  }`}
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    {c.ai && (
                      <span className="px-2 py-0.5 text-[10px] rounded-full bg-[#40086d] text-white">
                        AI
                      </span>
                    )}
                  ...
                  <div>
                    <button className="px-4 py-1.5 rounded bg-[#1e1e1e] text-white text-xs font-medium hover:bg-[#dccaf4] hover:text-[#1a0530] transition">
                      Open Campaign
                    </button>
                  </div>
                </div>
                ...
                {selectedCampaign === c.id && (
                  <div className="px-6 pb-6 pt-2 bg-[#ede0f8]/20">
                    ...
                    {/* Upload area */}
                    <div className="mt-4">
                      <div className="border-2 border-dashed border-gray-200 rounded bg-white py-8 text-center">
                    ...
                    <div className="mt-4">
                      ...
                      <textarea
                        className="w-full min-h-[90px] rounded border border-gray-200 bg-white p-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#dccaf4]"
