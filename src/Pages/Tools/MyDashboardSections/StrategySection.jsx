  ...
  return (
    <div className="bg-white border border-[rgba(30,30,30,0.1)] rounded p-4 shadow-sm">
      ...
      <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
        <div className="h-full bg-[#40086d]" style={{ width: value }} />
      </div>
    </div>
  );
}
    ...
    <>
      ...
      <div>
        <div className="flex items-center justify-between">
          ...
          <button className="px-4 py-2 rounded bg-[#ede0f8] text-[#40086d] text-xs font-semibold">
      ...
      <div>
        ...
        <div className="flex justify-center mt-4">
          <button className="px-4 py-2 rounded border border-[#dccaf4] text-[#40086d] text-xs font-semibold">
