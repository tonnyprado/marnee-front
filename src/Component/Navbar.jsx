...
export default function Navbar({ active = "ai-content" }) {
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <div className={`flex items-center ${collapsed ? 'justify-center' : 'justify-between'} px-4 py-5 border-b border-[rgba(30,30,30,0.1)]`}>
          <div
            onClick={() => navigate("/")}
            className={`cursor-pointer hover:opacity-80 transition ${collapsed ? 'scale-75' : ''}`}
          >
            <Logo dark={true} />
          </div>
          {!collapsed && (
        ...
        {collapsed && (
          <div className="px-4 py-2 border-b border-[rgba(30,30,30,0.1)]">
            <button
            ...
            return (
              <div key={item.id} className="relative group">
                <button
                  ...
                  className={`w-full flex items-center ${collapsed ? 'justify-center px-3' : 'gap-3 px-3'} py-3 rounded text-left transition ${
                    isActive
